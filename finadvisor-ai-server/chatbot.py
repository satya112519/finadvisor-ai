...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*", "http://localhost:3000", "http://localhost:80", "http://35.188.50.151:3000", "http://35.188.50.151:80", "http://35.188.50.151:80" , "http://35.188.50.151:81"],  # Adjust according to your frontend URL
